...
#include "WebserverConfig.h"
	...
	#define RBEnumerate RBTEnumerate
	#define RBTreeDestroy RBTDestroy
	#define RBTreeInsert RBTInsert
	#define RBExactQuery RBTQuery
	#define RBTreeCreate RBTCreate
	#define RBDelete RBTDelete
